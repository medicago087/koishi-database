...
export declare const UseEvent: (event: keyof import("koishi").Events<import("koishi").Context>, prepend?: boolean) => TypedMethodDecorator<(...args: any[]) => any>, UseBeforeEvent: (event: "send" | "attach-channel" | "attach-user" | "attach" | "internal/service" | "internal/update" | "parse" | "command/execute" | "command/attach-channel" | "command/attach-user", append?: boolean) => TypedMethodDecorator<((this: Session<never, never>, session: Session<never, never>) => boolean | void | Promise<boolean | void>) | ((session: Session<never, never>, fields: Set<keyof import("koishi").Channel>) => void) | ((session: Session<never, never>, fields: Set<keyof User>) => void) | ((session: Session<never, never>) => void) | ((name: string, value: any) => void) | ((fork: import("cordis").ForkScope<import("cordis").Context.Parameterized<import("koishi").Context, any>>, config: any) => void) | ((content: string, session: Session<never, never>) => Argv<never, never, any[], {}>) | ((argv: Argv<never, never, any[], {}>) => string | void | Promise<string | void>) | ((argv: Argv<never, never, any[], {}>, fields: Set<keyof import("koishi").Channel>) => void) | ((argv: Argv<never, never, any[], {}>, fields: Set<keyof User>) => void)>, UseMiddleware: (prepend?: boolean) => TypedMethodDecorator<(session: Session<never, never>, next: import("koishi").Next) => string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[] | import("rxjs").Observable<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[]> | Promise<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[] | import("rxjs").Observable<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[]>>>, UsePreset: (name: string) => TypedMethodDecorator<import("koishi").I18n.Renderer>, UseInterval: (interval: number) => TypedMethodDecorator<(...args: any[]) => any>;

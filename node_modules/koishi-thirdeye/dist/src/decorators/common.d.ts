...
export declare const OnAnywhere: () => ClassDecorator & MethodDecorator, OnNowhere: () => ClassDecorator & MethodDecorator, OnUser: (...args: string[]) => ClassDecorator & MethodDecorator, OnSelf: (...args: string[]) => ClassDecorator & MethodDecorator, OnGuild: (...args: string[]) => ClassDecorator & MethodDecorator, OnChannel: (...args: string[]) => ClassDecorator & MethodDecorator, OnPlatform: (...args: string[]) => ClassDecorator & MethodDecorator, OnPrivate: (...args: string[]) => ClassDecorator & MethodDecorator, OnSelection: (selection: import("../..").Selection) => ClassDecorator & MethodDecorator;
export declare const UseEvent: (event: keyof import("koishi").Events<import("koishi").Context>, prepend?: boolean) => TypedMethodDecorator<(...args: any[]) => any>, UseBeforeEvent: (event: "send" | "attach-channel" | "attach-user" | "attach" | "internal/service" | "internal/update" | "parse" | "command/execute" | "command/attach-channel" | "command/attach-user", append?: boolean) => TypedMethodDecorator<((name: string, value: any) => void) | ((fork: import("cordis").ForkScope<import("cordis").Context.Parameterized<import("koishi").Context, any>>, config: any) => void) | ((this: Session<never, never>, session: Session<never, never>, args_0: import("koishi").SendOptions) => boolean | void | Promise<boolean | void>) | ((session: Session<never, never>, fields: Set<keyof import("koishi").Channel>) => void) | ((session: Session<never, never>, fields: Set<keyof User>) => void) | ((session: Session<never, never>) => void) | ((content: string, session: Session<never, never>) => Argv<never, never, any[], {}>) | ((argv: Argv<never, never, any[], {}>) => string | void | Promise<string | void>) | ((argv: Argv<never, never, any[], {}>, fields: Set<keyof import("koishi").Channel>) => void) | ((argv: Argv<never, never, any[], {}>, fields: Set<keyof User>) => void)>, UseMiddleware: (prepend?: boolean) => TypedMethodDecorator<(session: Session<never, never>, next: import("koishi").Next) => string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[] | import("rxjs").Observable<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[]> | Promise<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[] | import("rxjs").Observable<string | void | import("@satorijs/element") | (string | import("@satorijs/element"))[]>>>, UsePreset: (name: string) => TypedMethodDecorator<import("koishi").I18n.Renderer>, UseInterval: (interval: number) => TypedMethodDecorator<(...args: any[]) => any>, UseComponent: (name: string, options?: import("koishi").Component.Options) => TypedMethodDecorator<import("koishi").Component>;
...
export declare const CommandShortcut: (pattern: string | RegExp, config: Command.Shortcut) => ClassDecorator & MethodDecorator;

...
export declare class KoishiRegistrar extends SatoriRegistrar<Context> {
    ...
    methodDecorators(): {
        ...
        UseBeforeEvent: (event: "attach-channel" | "attach-user" | "attach" | "send" | "internal/service" | "internal/update" | "parse" | "command/execute" | "command/attach-channel" | "command/attach-user", append?: boolean) => import("satori-decorators").TypedMethodDecorator<((session: Session<never, never>, fields: Set<keyof import("koishi").Channel>) => void) | ((session: Session<never, never>, fields: Set<keyof import("koishi").User>) => void) | ((session: Session<never, never>) => void) | Session.EventCallback<boolean | void | Promise<boolean | void>> | ((name: string, value: any) => void) | ((fork: import("cordis").Fork<import("cordis").Context.Parameterized<Context, any>>, config: any) => void) | ((content: string, session: Session<never, never>) => import("koishi").Argv<never, never, any[], {}>) | ((argv: import("koishi").Argv<never, never, any[], {}>) => string | void | Promise<string | void>) | ((argv: import("koishi").Argv<never, never, any[], {}>, fields: Set<keyof import("koishi").Channel>) => void) | ((argv: import("koishi").Argv<never, never, any[], {}>, fields: Set<keyof import("koishi").User>) => void)>;
        ...
        UseFormatter: (name: string) => import("satori-decorators").TypedMethodDecorator<I18n.Formatter>;
        ...
        RouterMethod: (method: "options" | "get" | "post" | "put" | "delete" | "patch" | "head" | "all", path: string) => import("satori-decorators").TypedMethodDecorator<(ctx: import("satori-decorators").KoaContext, Next: import("koa").Next) => Promise<any>>;

...
type CommandReg<A extends any[] = any[], R = any> = (ctx: Context, command: Command, ...args: A) => R;
export type CommandTransformer<A extends any[] = any[]> = CommandReg<A, Command>;
...
export type CommandPutPre<A extends any[] = any[]> = (data: CommandPutData, ...args: A) => any;
export type CommandPut<A extends any[] = any[]> = (data: CommandPutRuntime, ...args: A) => any;
...
export type CommandReturnType = CanBeObserved<string | void | segment | (string | segment)[]>;
export {};

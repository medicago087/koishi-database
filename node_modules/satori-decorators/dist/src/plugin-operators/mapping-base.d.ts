...
export declare type MapPluginToConfig<Ctx extends Context, M extends Dict<PluginClass<Ctx>>> = {
    [K in keyof M]: ClassPluginConfig<M[K]>;
};
export declare type MapPluginToConfigWithSelection<Ctx extends Context, M extends Dict<PluginClass<Ctx>>> = {

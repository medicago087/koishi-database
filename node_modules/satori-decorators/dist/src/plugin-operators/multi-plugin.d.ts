...
export declare class MultiInstancePluginFramework<Ctx extends Context, InnerPlugin extends PluginClass<Ctx>> extends BasePlugin<Ctx, Instances<ClassPluginConfig<InnerPlugin>>, Instances<ClassPluginConfig<InnerPlugin> & Selection>> {
    instances: TypeFromClass<InnerPlugin>[];
    _getInnerPlugin(): InnerPlugin;
    _registerInstances(): void;
    _onThingsDispose(): void;
}
export declare function MultiInstancePlugin<Ctx extends Context, InnerPlugin extends PluginClass<Ctx>, OuterConfig>(innerPlugin: InnerPlugin, outerConfig?: ClassType<OuterConfig>): new (ctx: import("cordis").Context<any>, config: import("cordis-decorators").PartialDeep<OuterConfig> & Instances<PluginRegistrar.ClassPluginConfig<InnerPlugin> & Selection>) => {
    _getInnerPlugin(): InnerPlugin;
    instances: TypeFromClass<InnerPlugin>[];
    _registerInstances(): void;
    _onThingsDispose(): void;

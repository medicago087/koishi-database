...
exports.UseEvent = methodDecorators.UseEvent, exports.UseBeforeEvent = methodDecorators.UseBeforeEvent, exports.UseMiddleware = methodDecorators.UseMiddleware, exports.UsePreset = methodDecorators.UsePreset, exports.UseFormatter = methodDecorators.UseFormatter, exports.UseInterval = methodDecorators.UseInterval;
...
exports.CommandShortcut = registrar_1.koishiRegistrar.decorateCommandTransformer((ctx, cmd, name, config = {}) => cmd.shortcut(name, config));

...
const cwd = (0, path_1.join)((0, env_paths_1.default)('gocqhttp').data, _1.version);
const backup = (0, path_1.join)(cwd, _1.basename);
...
async function install() {
    ...
    await fs_1.promises.copyFile(backup, _1.binary);
}

...
function apply(ctx, config) {
    ...
    const cmd = ctx.command('novelai <prompts:text>')
        ...
        if (imgUrl) {
            ...
            if (options.enhance) {
                const size = (0, utils_1.getImageSize)(image[0]);
                ...
                options.resolution || (options.resolution = (0, utils_1.resizeInput)((0, utils_1.getImageSize)(image[0])));
                Object.assign(parameters, {
        ...
        if (!base64.trim())
            return session.text('.empty-response');
        function getContent() {

...
exports.parseInput = exports.parseForbidden = exports.Config = exports.PromptConfig = exports.upscalers = exports.sampler = exports.orients = exports.models = exports.orientMap = exports.modelMap = void 0;
...
exports.PromptConfig = koishi_1.Schema.object({
    ...
    forbidden: koishi_1.Schema.string().role('textarea').description('违禁词列表。请求中的违禁词将会被自动删除。').default(''),
...
exports.Config = koishi_1.Schema.intersect([
    ...
    koishi_1.Schema.union([
        koishi_1.Schema.object({
            ...
            upscaler: koishi_1.Schema.union(exports.upscalers).description('默认的放大算法。').default('Lanczos'),
        }).description('参数设置'),
        koishi_1.Schema.object({
            type: koishi_1.Schema.const('naifu'),
    ...
    koishi_1.Schema.object({
        scale: koishi_1.Schema.number().description('默认对输入的服从度。').default(11),
        textSteps: koishi_1.Schema.natural().description('文本生图时默认的迭代步数。').default(28),
        imageSteps: koishi_1.Schema.natural().description('以图生图时默认的迭代步数。').default(50),
        maxSteps: koishi_1.Schema.natural().description('允许的最大迭代步数。').default(64),
        resolution: koishi_1.Schema.union([
            koishi_1.Schema.const('portrait').description('肖像 (768x512)'),
            koishi_1.Schema.const('landscape').description('风景 (512x768)'),
            koishi_1.Schema.const('square').description('方形 (640x640)'),
            koishi_1.Schema.object({
                width: koishi_1.Schema.natural().description('图片宽度。').default(640),
                height: koishi_1.Schema.natural().description('图片高度。').default(640),
            }).description('自定义'),
        ]).description('默认生成的图片尺寸。').default('portrait'),
        maxResolution: koishi_1.Schema.natural().description('允许生成的宽高最大值。').default(1024),
    }),
    ...
    koishi_1.Schema.object({
        ...
        maxIterations: koishi_1.Schema.natural().description('允许的最大绘制次数。').default(1),

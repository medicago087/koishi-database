...
import { Context, Observed, Service, Argv, Awaitable, Next, Session, User, Dict, Fragment, Query, Schema } from 'koishi';
...
export function triggerDialogue(ctx: Context, session: Session, next?: Next): Promise<any>;
declare module 'koishi' {
    interface Events {
...
export const using: readonly ["database"];

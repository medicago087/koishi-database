...
export default class Redlock extends EventEmitter {
     ...
     */
    calculateDrift(duration, settings) {
        var _a;
        // Add 2 milliseconds to the drift to account for Redis expires precision,
        // which is 1 ms, plus the configured allowable drift factor.
        return (Math.round(((_a = settings === null || settings === void 0 ? void 0 : settings.driftFactor) !== null && _a !== void 0 ? _a : this.settings.driftFactor) * duration) + 2);
    }
    /**

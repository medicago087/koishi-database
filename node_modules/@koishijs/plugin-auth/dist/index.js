...
import { ref as A, watch as I, defineComponent as S, resolveComponent as m, openBlock as l, createElementBlock as a, Fragment as V, unref as s, createElementVNode as r, toDisplayString as $, createVNode as u, withCtx as i, createTextVNode as w, createCommentVNode as H, withKeys as K, withModifiers as O, createBlock as U, computed as j, renderList as N, isRef as R } from "../vue.js";
...
I(() => _.user, (o, e) => {
  ...
  const c = E.currentRoute.value.redirectedFrom;
  c && !c.path.startsWith("/login") ? E.push(c) : E.push("/profile");
});
const q = { class: "login-form" }, G = { key: 0 }, J = /* @__PURE__ */ r("span", null, "\u5E73\u53F0\u8D26\u6237\u7ED1\u5B9A", -1), Q = [
  J
], X = { key: 1 }, Y = /* @__PURE__ */ r("span", null, "\u5E73\u53F0\u8D26\u6237\u767B\u5F55", -1), Z = [
  Y
], ee = { class: "hint" }, te = /* @__PURE__ */ r("p", { class: "hint" }, "\u8BF7\u7528\u4E0A\u8FF0\u8D26\u53F7\u5C06\u4E0B\u9762\u7684\u9A8C\u8BC1\u7801\u53D1\u9001\u7ED9\u4EFB\u610F\u6B63\u5728\u8FD0\u884C\u7684\u673A\u5668\u4EBA", -1), oe = { class: "token" }, se = { class: "control" }, ne = { key: 0 }, ue = /* @__PURE__ */ r("span", null, "\u5E73\u53F0\u8D26\u6237\u7ED1\u5B9A", -1), le = [
  ue
], re = {
  key: 0,
  class: "error"
  ...
  setup(o) {
    ...
    async function g() {
      ...
      if (k < f)
        return;
      const { platform: n, userId: d } = t;
      if (!(!n || !d)) {
        f = k + 1e3;
        try {
          c.value = await z("login/platform", n, d, (y = _.user) == null ? void 0 : y.id);
        } catch (p) {
          e.value = p.message;
        }
      }
    ...
    async function M() {
      const { name: k, password: n } = t;
      try {
        await z("login/password", k, n);
      } catch (d) {
        e.value = d.message;
      }
    }
    ...
    return (k, n) => {
      ...
      return l(), a("div", q, [
        c.value ? (l(), a(V, { key: 0 }, [
          s(_).user ? (l(), a("h1", G, Q)) : (l(), a("h1", X, Z)),
          r("p", ee, "\u6B22\u8FCE\u4F60\uFF0C" + $(c.value.name || "Koishi \u7528\u6237") + "\uFF01", 1),
          te,
          r("p", oe, $(c.value.token), 1),
          r("div", se, [
            u(d, {
              onClick: n[0] || (n[0] = (h) => c.value.token = null)
            }, {
              default: i(() => [
                w("\u8FD4\u56DE\u4E0A\u4E00\u6B65")
              ]),
          ...
          s(_).user ? (l(), a("h1", ne, le)) : H("", !0),
          r("h1", null, [
            u(y, {
              data: ["\u5E73\u53F0\u8D26\u6237\u767B\u5F55", "\u7528\u6237\u540D\u5BC6\u7801\u767B\u5F55"],
              modelValue: s(t).authType,
              "onUpdate:modelValue": n[1] || (n[1] = (h) => s(t).authType = h)
            }, null, 8, ["modelValue"])
          ]),
          s(_).user || s(t).authType === 0 ? (l(), a(V, { key: 1 }, [
            u(F, {
              placeholder: "\u5E73\u53F0\u540D",
              modelValue: s(t).platform,
              "onUpdate:modelValue": n[2] || (n[2] = (h) => s(t).platform = h)
            }, {
              prefix: i(() => [
                u(p, { name: "at" })
              ]),
            ...
            u(F, {
              ...
              "onUpdate:modelValue": n[3] || (n[3] = (h) => s(t).userId = h),
            ...
            e.value ? (l(), a("p", re, $(e.value), 1)) : H("", !0),
            r("div", ce, [
              u(d, { onClick: C }, {
                default: i(() => [
                  w("\u8FD4\u56DE")
            ...
            u(F, {
              placeholder: "\u7528\u6237\u540D",
              modelValue: s(t).name,
              "onUpdate:modelValue": n[4] || (n[4] = (h) => s(t).name = h)
            }, {
              prefix: i(() => [
                u(p, { name: "user" })
              ]),
            ...
            u(F, {
              ...
              "onUpdate:modelValue": n[6] || (n[6] = (h) => s(t).password = h),
              ...
              suffix: i(() => [
                u(p, {
                  ...
                  onClick: n[5] || (n[5] = (h) => s(t).showPass = !s(t).showPass)
                }, null, 8, ["name"])
              ]),
              _: 1
            }, 8, ["modelValue", "onKeypress", "type"]),
            e.value ? (l(), a("p", ae, $(e.value), 1)) : H("", !0),
            r("div", ie, [
              u(d, { onClick: C }, {
                default: i(() => [
                  w("\u8FD4\u56DE")
...
const _e = /* @__PURE__ */ S({
  ...
  setup(o) {
    return (e, c) => {
      ...
      return l(), U(g, { main: "darker page-login" }, {
        default: i(() => [
          u(f, null, {
            default: i(() => [
              u(P)
...
const de = { class: "k-schema-header" }, pe = { class: "schema-item" }, he = { class: "header" }, me = { class: "left" }, fe = /* @__PURE__ */ r("div", { class: "right" }, null, -1), ge = /* @__PURE__ */ S({
  __name: "profile",
  setup(o) {
    const e = A({}), c = j(() => {
      const v = L.object({
    ...
    return (v, C) => {
      const k = m("el-button"), n = m("k-form"), d = m("k-content"), y = m("k-layout");
      return l(), U(y, {
        main: "page-profile",
        menu: s(M)
      }, {
            ...
            default: i(() => [
              u(n, {
                ...
                epilog: i(() => [
                  ...
                  (l(!0), a(V, null, N(s(_).user.accounts, ({ platform: p, id: F }) => (l(), a("div", pe, [
                    r("div", he, [
                      r("div", me, $(p) + " (" + $(F) + ")", 1),
                      fe
                    ])
...
function Ye(o, e) {
  return l(), a("svg", Je, Xe);
}
const Ze = /* @__PURE__ */ D(Ge, [["render", Ye]]), e2 = /* @__PURE__ */ S({
  __name: "bind-dialog",
  setup(o) {
    return (e, c) => {
      const f = m("el-dialog");
      return l(), U(f, {
        center: "",
        modelValue: s(B),
        "onUpdate:modelValue": c[0] || (c[0] = (g) => R(B) ? B.value = g : null),
        class: "bind-dialog"
      }, {
        default: i(() => [
          u(P)
...
const n2 = (o) => {
  t.token && t.expire > Date.now() && z("login/token", t.id, t.token).catch((e) => b.error(e.message)), o.on("activity", (e) => e.authority > 0 && (!_.user || _.user.authority < e.authority)), o.state.disposables.push(E.beforeEach((e) => {
    if ((e.meta.authority || e.meta.fields.includes("user")) && !_.user)
      return history.state.forward === "/login" ? "/" : "/login";
    if (e.meta.authority && e.meta.authority > _.user.authority)
      return b.error("\u6743\u9650\u4E0D\u8DB3\u3002"), !1;
  })), o.page({
    path: "/login",
    name: "\u767B\u5F55",
    icon: "sign-in",
    position: () => _.user ? "hidden" : "bottom",
    component: _e
  }), o.page({
    path: "/profile",
    name: "\u7528\u6237\u8D44\u6599",

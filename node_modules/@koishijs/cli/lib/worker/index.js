...
// koishi/packages/cli/src/locales/zh-CN.yml
...
// koishi/packages/cli/src/locales/ja-JP.yml
...
// koishi/packages/cli/src/locales/fr-FR.yml
...
var Config = import_koishi.Schema.object({
  ...
  heartbeatInterval: import_koishi.Schema.number().description("心跳发送间隔。").default(0),
  heartbeatTimeout: import_koishi.Schema.number().description("心跳超时时间。").default(0)
}).description("守护设置");

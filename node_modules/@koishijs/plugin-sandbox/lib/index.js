...
var SandboxBot = class extends import_koishi.Bot {
  ...
  async sendMessage(channelId, fragment, guildId, options) {
    return new SandboxMessenger(this, channelId, guildId, options).send(fragment);
  }
  async sendPrivateMessage(userId, fragment, options) {
    return new SandboxMessenger(this, "@" + userId, void 0, options).send(fragment);
  }

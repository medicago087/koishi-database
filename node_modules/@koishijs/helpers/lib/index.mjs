...
var require_zh = __commonJS({
  "packages/helpers/src/locales/zh.yml"(exports, module) {
    module.exports = { internal: { "error-encountered": "发生未知错误：{0}" }, admin: { "user-option": "指定目标用户", "user-not-found": "未找到指定的用户。", "user-unchanged": "用户数据未改动。", "user-updated": "用户数据已修改。", "channel-option": "指定目标频道", "channel-not-found": "未找到指定的频道。", "channel-unchanged": "频道数据未改动。", "channel-updated": "频道数据已修改。", "not-in-group": "当前不在群组上下文中，请使用 -c 参数指定目标频道。" } };
  }
});

// packages/helpers/src/locales/en.yml
var require_en = __commonJS({
  "packages/helpers/src/locales/en.yml"(exports, module) {
    module.exports = { internal: { "error-encountered": "An unknown error has occurred: {0}" }, admin: { "user-not-found": "User not found.", "user-unchanged": "User data unchanged.", "user-updated": "User data updated.", "channel-not-found": "Channel not found.", "channel-unchanged": "Channel data unchanged.", "channel-updated": "Channel data updated.", "not-in-group": "Not in guild context, use -c to specify target channel." } };
  }
});

// packages/helpers/src/locales/ja.yml
var require_ja = __commonJS({
  "packages/helpers/src/locales/ja.yml"(exports, module) {
    module.exports = { internal: { "error-encountered": "不明なエラーが発生しました：{0}" }, admin: { "user-option": "特定のユーザーを指定する", "user-not-found": "指定されたユーザーが見つかりません。", "user-unchanged": "ユーザーデータは変更されていません。", "user-updated": "ユーザーデータが変更されました。", "channel-option": "特定のチャンネルを指定する", "channel-not-found": "指定されたチャンネルが見つかりません。", "channel-unchanged": "チャンネルデータは変更されていません。", "channel-updated": "チャンネルデータが変更されました。", "not-in-group": "ギルドコンテキストではありません。-c を使用して特定のチャンネルを指定します。" } };
  }
});

// packages/helpers/src/locales/fr.yml
var require_fr = __commonJS({
  "packages/helpers/src/locales/fr.yml"(exports, module) {
    module.exports = { internal: { "error-encountered": "Une erreur inconnue s'est produite : {0}" }, admin: { "user-not-found": "Utilisateur introuvable.", "user-unchanged": "Les données utilisateur n'ont pas été modifiées.", "user-updated": "Les données utilisateur ont été changées.", "channel-not-found": "Canel introuvable.", "channel-unchanged": "Les données du canel n'ont pas été modifiées.", "channel-updated": "Les données du canel ont été changées.", "not-in-group": "Vous n'êtes pas dans le contexte du groupe, tapez -c pour spécifier le canel cible." } };
  }
});

// packages/helpers/src/locales/zh-tw.yml
var require_zh_tw = __commonJS({
  "packages/helpers/src/locales/zh-tw.yml"(exports, module) {
    module.exports = { internal: { "error-encountered": "出現未知錯誤：{0}" }, admin: { "user-not-found": "找不到指定的用戶。", "user-unchanged": "用戶資料未更新。", "user-updated": "用戶資料已更新。", "channel-option": "指定目標頻道", "channel-not-found": "找不到指定的頻道。", "channel-unchanged": "頻道資料未更新。", "channel-updated": "頻道資料已更新。", "not-in-group": "當前不在群組上下文中，請使用 -c 參數指定目標頻道。" } };
  }
});

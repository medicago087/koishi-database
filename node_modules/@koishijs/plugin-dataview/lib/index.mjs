...
// koishi/external/console/packages/dataview/src/index.ts
import { Schema } from "koishi";
import { DataService } from "@koishijs/plugin-console";
import { resolve } from "path";

// koishi/external/console/packages/dataview/src/utils.ts
...
__publicField(DatabaseProvider, "using", ["console", "database"]);
((DatabaseProvider2) => {

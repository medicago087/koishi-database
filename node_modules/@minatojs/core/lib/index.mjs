...
import { makeArray as makeArray2, valueMap as valueMap2 } from "cosmokit";
...
var Model = class {
  ...
  create(data) {
    ...
    for (const key in this.fields) {
      if (!keys.includes(key) && !isNullable2(this.fields[key].initial)) {
...
import { defineProperty as defineProperty2, valueMap } from "cosmokit";
...
var Executable = class {
  ...
  constructor(driver, payload) {
    ...
    defineProperty2(this, "row", createRow(this.ref));
...
var Driver = class {
  ...
  model(table) {
    ...
    model.fields = valueMap2(table.args[0].fields, () => ({
      type: "expr"
    }));
    return model;
  }

...
export declare class BaseBot<T extends BaseBot.Config = BaseBot.Config> extends Bot<T> {
    parent?: BaseBot;
    internal: OneBot.Internal;
    sendMessage(channelId: string, fragment: Fragment, guildId?: string): Promise<string[]>;
    sendPrivateMessage(userId: string, fragment: Fragment): Promise<string[]>;
    ...
    getFriendList(): Promise<import("@satorijs/core").Universal.User[]>;

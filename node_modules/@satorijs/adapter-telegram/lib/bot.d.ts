import { Bot, Context, Dict, Fragment, Quester, Schema, SendOptions, Session, Universal } from '@satorijs/satori';
...
export declare class TelegramBot<T extends TelegramBot.Config = TelegramBot.Config> extends Bot<T> {
    ...
    sendMessage(channelId: string, fragment: Fragment, guildId?: string, options?: SendOptions): any;
    sendPrivateMessage(userId: string, content: Fragment, options?: SendOptions): any;

...
// satori/packages/core/src/internal.ts
var import_cosmokit = require("cosmokit");
var Internal = class {
  constructor(app) {
    this.app = app;
    this.counter = 0;
    this.transformers = /* @__PURE__ */ Object.create(null);
...
var Session2 = class {
  constructor(bot, payload) {
    ...
    (0, import_cosmokit2.defineProperty)(this, "id", ++bot.ctx.internal.counter);
    this.initialize();
  }
  initialize() {
  }
  ...
  async transform(elements) {
    return await import_element.default.transformAsync(elements, this.app.internal.transformers, this);
  }
  toJSON() {
...
var Bot = class {
  ...
  session(payload) {
    return new Session2(this, payload);
  }
  dispatch(session) {
...
var Messenger = class {
  ...
  async send(content) {
    var _a;
    const session = (_a = this.options.session) != null ? _a : this.session;
...
// satori/packages/core/src/index.ts
import_element3.default.warn = new import_reggol2.default("element").warn;

...
__name(KookModulator, "KookModulator");
((KookModulator2) => {
  KookModulator2.Config = import_satori4.Schema.object({
...
var KookBot = class extends import_satori5.Bot {
  ...
  async editMessage(channelId, msg_id, content) {
    content = import_satori5.segment.normalize(content).toString();
    if (channelId.length > 30) {
